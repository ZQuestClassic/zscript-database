...
const int I_DIFF_VERYEASY = 0;
const int I_DIFF_EASY = 0;
const int I_DIFF_NORMAL = 0;
const int I_DIFF_HARD = 0;
const int I_DIFF_VERYHARD = 0;
...
void DifficultyGlobal_Init(bool resetOverride){
	...
	for(i=0; i<__DI_ENEMYTABLES_MAXSIZE; ++i)
